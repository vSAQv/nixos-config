{
  ...
  programs.yazi = {
    ...
    # Установка темы Gruvbox через механизм flavors
    flavors = {
    ...
    theme = {
      # Активация темы (строго внутри theme.toml)
      flavor = {
        dark = "gruvbox-dark";
        light = "gruvbox-dark";
      };
      ...
      icon = {
        ...
        # Базовая желтая иконка для всех остальных папок
        prepend_conds = [
          {
            "if" = "dir";
            text = "";
      ...
      # 2. Перекрашиваем текст директорий и специфичных файлов
      filetype = {
        prepend_rules = [
          {
            mime = "image/*";
